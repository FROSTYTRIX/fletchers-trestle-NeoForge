...
public class SteamingRecipe implements Recipe<SingleRecipeInput> {
    ...
    // 26.1: ItemStackTemplate for the result — see ShavingHorseRecipe note.
    private final ItemStackTemplate result;
    private final int waterAmount;
    private final int processingTime;

    public SteamingRecipe(Ingredient input, ItemStackTemplate result, int waterAmount, int processingTime) {
        this.input = input;
        this.result = result;
