    ...
    protected void start() {
        this.add("mechanical_trigger_from_pillager_outpost",
                new AddItemModifier(new LootItemCondition[]{
                        new LootTableIdCondition.Builder(Identifier.withDefaultNamespace("chests/pillager_outpost")).build(),
        ...
        this.add("mechanical_trigger_from_bastion_other",
                new AddItemModifier(new LootItemCondition[]{
                        new LootTableIdCondition.Builder(Identifier.withDefaultNamespace("chests/bastion_bridge")).build(),
